...
include_once($GLOBALS['ROOT'] . '/framework_code/utility_functions.php');
include_once($GLOBALS['ROOT'] . '/framework_code/db_functions.php');
include_once($GLOBALS['ROOT'] . '/framework_code/user_manager.php');
?>